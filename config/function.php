...
require "config_diskon.php";

function diskonspp($spp, $anakguru, $anakyayasan, $asalsekolah, $statdiskon)
{
	if ($statdiskon == 1) {
		if ($anakguru == 1) {
			$diskon = diskonsppanakguru / 100 * $spp;
		} elseif ($anakyayasan == 1) {
			$diskon = diskonsppanakyayasan1 / 100 * $spp;
		} elseif ($anakyayasan == 2) {
			$diskon = diskonsppanakyayasan2 / 100 * $spp;
		} elseif ($anakyayasan == 3) {
			$diskon = diskonsppanakyayasan3 / 100 * $spp;
		} elseif ($asalsekolah == "TK MARIA") {
			$diskon = diskonsppasalsekolah / 100 * $spp;
		} else {
			$diskon = $spp;
		}
	} else {
...
function diskonspb($spb, $anakguru, $asalsekolah, $statdiskon)
{
	if ($statdiskon == 1) {
		if ($anakguru == 1) {
			$diskon = diskonspbanakguru / 100 * $spb;
		} elseif ($asalsekolah == "TK MARIA") {
			$diskon = diskonspbasalsekolah / 100 * $spb;
		} else {
			$diskon = $spb;
		}
	} else {
